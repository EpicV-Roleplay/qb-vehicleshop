...
Config.Shops = {
   ...
   ['mas'] = {
    ...
    ['trailer'] = {
        ...
        ['Zone'] = {
            ['Shape'] = {
                vector2(166.44140625, 2742.59375),
                vector2(164.70986938477, 2756.6442871094),
                vector2(172.5792388916, 2757.4389648438),
                vector2(172.99600219727, 2752.2880859375),
                vector2(170.93644714355, 2752.1123046875),
                vector2(171.92292785645, 2743.9711914063)
            },
            ['minZ'] = 31.485809326172,
            ['maxZ'] = 31.49555015564
        },
        ['Job'] = 'none', -- Name of job or none
        ['ShopLabel'] = 'Trailers and More',
        ['showBlip'] = true,  --- true or false
        ['Categories'] = {
            --['super'] = 'Super',
            --['sports'] = 'Sports'
        ...
        ['TestDriveTimeLimit'] = 0.5,
        ['Location'] = vector3(169.77, 2748.72, 43.41),
        ['ReturnLocation'] = vector3(193.91, 2759.87, 43.43),
        ['VehicleSpawn'] = vector4(211.1, 2748.89, 43.43, 89.69),
        ['ShowroomVehicles'] = {
            [1] = {
                coords = vector4(168.61, 2749.85, 44.45 -1.4, 273.71), --vector4(169.44, 2746.52, 43.42 -0.9, 278.02)
                defaultVehicle = 'trailersmall',
                chosenVehicle = 'trailersmall',
            },
            [2] = {
                coords = vector4(168.98, 2754.19, 43.63 -1.2, 276.76), --vector4(-207.19, 6202.81, 30.89, 251.33)
                defaultVehicle = 'mule2',
                chosenVehicle = 'mule2',
            },
            [3] = {
                coords = vector4(169.44, 2746.52, 43.42 -1.0, 278.02), --vector4(-207.19, 6202.81, 30.89, 251.33)
